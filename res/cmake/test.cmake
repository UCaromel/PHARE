...
if (test AND ${PHARE_EXEC_LEVEL_MIN} GREATER 0) # 0 = no tests
  ...
  add_subdirectory(tests/amr/solvers/momentum_tensor_border_filler)
  add_subdirectory(tests/amr/messengers)
  add_subdirectory(tests/amr/messengers/cross_model_fill_context)
  ...
  add_subdirectory(tests/functional/mhd_hybrid_harris)
