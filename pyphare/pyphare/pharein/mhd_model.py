...
class MHDModel(object):
    ...
    def __init__(
        ...
        # evaluates these analytic conserved integrands directly -- GL-integrated at fourth order,
        # point-sampled at second -- so the nonlinear primitive-to-conserved map is never applied
        # to already-discretized arrays. Primitives stay in model_dict (harmless; any
