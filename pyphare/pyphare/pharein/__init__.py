...
def populateDict():
    ...
    addInitFunction("state/density/initializer", fn_wrapper(modelDict["density"]))
    addInitFunction("state/velocity/initializer/x_component", fn_wrapper(modelDict["vx"]))
    addInitFunction("state/velocity/initializer/y_component", fn_wrapper(modelDict["vy"]))
    addInitFunction("state/velocity/initializer/z_component", fn_wrapper(modelDict["vz"]))
    addInitFunction("state/magnetic/initializer/x_component", fn_wrapper(modelDict["bx"]))
    addInitFunction("state/magnetic/initializer/y_component", fn_wrapper(modelDict["by"]))
    addInitFunction("state/magnetic/initializer/z_component", fn_wrapper(modelDict["bz"]))
    addInitFunction("state/pressure/initializer", fn_wrapper(modelDict["p"]))
