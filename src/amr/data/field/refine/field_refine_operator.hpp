 ...
 * same runtime kernel.
 */
template<std::size_t rank, typename GridLayoutT, typename FieldT>
...
template<typename GridLayoutT, typename FieldT>
using KernelVecFieldRefineOperator
    = KernelTensorFieldRefineOperator</*rank=*/1, GridLayoutT, FieldT>;
