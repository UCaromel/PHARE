...
// the model's quantity type: MHD instantiates with PhysicalQuantity::Scalar, Hybrid with
// PhysicalQuantity::Scalar. The Yee B-face centering pattern is identical across models, so
