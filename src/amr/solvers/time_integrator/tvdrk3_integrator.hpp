...
public:
                    ...
                    double const currentTime, double const newTime)
    {
        ...
        // RKUtils combines only interiors. Refill U2's conserved ghosts at its abscissa; the
        // selected messenger policy performs Linear2 transfer or the uniform No-CF fill.
        ...
        bc.fillConservativeGhosts(state2_, level, stageTime);
