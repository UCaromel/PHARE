...
{
    using HybridModel = typename PHARETypes::Hybrid::Model_t;
    using SolverPPC   = typename PHARETypes::Hybrid::Solver_t;
...
{
    using MHDModel  = typename PHARETypes::MHD::Model_t;
    using SolverMHD = typename PHARETypes::MHD::Solver_t;
