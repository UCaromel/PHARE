...
namespace core
{
    ...
    public:
        ...
        constexpr auto static initLayoutCentering_()
        {
            ...
            std::array<QtyCentering, NBR_COMPO> const Bxc = {{data.dual, data.dual, data.dual}};
            std::array<QtyCentering, NBR_COMPO> const Byc = {{data.dual, data.dual, data.dual}};
            std::array<QtyCentering, NBR_COMPO> const Bzc = {{data.dual, data.dual, data.dual}};
    ...
    public:
        ...
        centering(MHDQuantity::Scalar MHDQuantity)
        {
            ...
            if constexpr (dim == 1)
            {
                switch (MHDQuantity)
                {
                    ...
                    case MHDQuantity::Scalar::Bxc:
                        return {{_QtyCentering_[gridData_.iBxc][gridData_.idirX]}};
                    case MHDQuantity::Scalar::Byc:
                        return {{_QtyCentering_[gridData_.iByc][gridData_.idirX]}};
                    case MHDQuantity::Scalar::Bzc:
                        return {{_QtyCentering_[gridData_.iBzc][gridData_.idirX]}};
            ...
            else if constexpr (dim == 2)
            {
                switch (MHDQuantity)
                {
                    ...
                    case MHDQuantity::Scalar::Bxc:
                        return {{_QtyCentering_[gridData_.iBxc][gridData_.idirX],
                                 _QtyCentering_[gridData_.iBxc][gridData_.idirY]}};
                    case MHDQuantity::Scalar::Byc:
                        return {{_QtyCentering_[gridData_.iByc][gridData_.idirX],
                                 _QtyCentering_[gridData_.iByc][gridData_.idirY]}};
                    case MHDQuantity::Scalar::Bzc:
                        return {{_QtyCentering_[gridData_.iBzc][gridData_.idirX],
                                 _QtyCentering_[gridData_.iBzc][gridData_.idirY]}};
                    case MHDQuantity::Scalar::Bx:
                        return {{_QtyCentering_[gridData_.iBx][gridData_.idirX],
            ...
            else if constexpr (dim == 3)
            {
                switch (MHDQuantity)
                {
                    ...
                    case MHDQuantity::Scalar::Bxc:
                        return {{_QtyCentering_[gridData_.iBxc][gridData_.idirX],
                                 _QtyCentering_[gridData_.iBxc][gridData_.idirY],
                                 _QtyCentering_[gridData_.iBxc][gridData_.idirZ]}};
                    case MHDQuantity::Scalar::Byc:
                        return {{_QtyCentering_[gridData_.iByc][gridData_.idirX],
                                 _QtyCentering_[gridData_.iByc][gridData_.idirY],
                                 _QtyCentering_[gridData_.iByc][gridData_.idirZ]}};
                    case MHDQuantity::Scalar::Bzc:
                        return {{_QtyCentering_[gridData_.iBzc][gridData_.idirX],
                                 _QtyCentering_[gridData_.iBzc][gridData_.idirY],
                                 _QtyCentering_[gridData_.iBzc][gridData_.idirZ]}};
                    case MHDQuantity::Scalar::Bx:
                        return {{_QtyCentering_[gridData_.iBx][gridData_.idirX],
                                 _QtyCentering_[gridData_.iBx][gridData_.idirY],
        ...
        centering(MHDQuantity::Vector MHDQuantity)
        {
            switch (MHDQuantity)
            {
                ...
                case MHDQuantity::Vector::Bc:
                    return {{centering(MHDQuantity::Scalar::Bxc),
                             centering(MHDQuantity::Scalar::Byc),
                             centering(MHDQuantity::Scalar::Bzc)}};
