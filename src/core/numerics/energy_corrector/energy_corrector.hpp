...
public:
    ...
    void operator()(Field& Etot, VecField const& B, VecField const& Bc)
    {
        if (!this->hasLayout())
...
private:
    ...
    void correct_(auto& Etot, auto const& B, auto const& Bc, MeshIndex<dimension> index)
    {
        ...
        auto const B2c = Bxc * Bxc + Byc * Byc + Bzc * Bzc;
