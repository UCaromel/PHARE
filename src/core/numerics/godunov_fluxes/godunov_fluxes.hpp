...
template<typename GridLayout, template<typename> typename Reconstruction,
         template<typename> typename RiemannSolver, typename Equations, bool Hall, bool Resistivity,
...
public:
    ...
    void operator()(State& state, Fluxes&... fluxes) const
    {
        ...
        Godunov_ref<GridLayout, Reconstruction, RiemannSolver, Equations, Hall, Resistivity,
                    HyperResistivity>{
            *this->layout_,
            gamma_,
            eta_,
