...
COMBINATIONS = (HARRIS_2D_COMBINATION,)


def config(
    combination=HARRIS_2D_COMBINATION,
...
class Harris2DTest(SimulatorTest):
...
def generate_golden_data(combination=HARRIS_2D_COMBINATION):
...
if __name__ == "__main__":
    ...
    if "--generate" in sys.argv:
        ...
        Harris2DTest().test_matches_reference().tearDown()
