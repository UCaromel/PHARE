...
COMBINATIONS = (HARRIS_3D_AMR_COMBINATION,)


def config(
    combination=HARRIS_3D_AMR_COMBINATION,
...
class Harris3DAMRTest(SimulatorTest):
...
def generate_golden_data(combination=HARRIS_3D_AMR_COMBINATION):
...
if __name__ == "__main__":
    ...
    if "--generate" in sys.argv:
        ...
        Harris3DAMRTest().test_matches_reference().tearDown()
