...
ORSZAG_TANG_3D_AMR_COMBINATION = {
...
COMBINATIONS = (ORSZAG_TANG_3D_AMR_COMBINATION,)


def config(
    combination=ORSZAG_TANG_3D_AMR_COMBINATION,
...
class OrszagTang3DAMRTest(SimulatorTest):
...
def generate_golden_data(combination=ORSZAG_TANG_3D_AMR_COMBINATION):
...
if __name__ == "__main__":
    ...
    if "--generate" in sys.argv:
        ...
        OrszagTang3DAMRTest().test_matches_reference().tearDown()
