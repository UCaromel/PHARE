...
TEST(HallConvergence, WENOZReconstruct1D)
{
    ...
    {
        double dx = 1.0 / n;
        using Layout = typename PHARE::core::PHARE_Types<PHARE::SimOpts{1, 2}>::MHD::GridLayout_t;
...
TEST(HallConvergence, EdgeToCellProjection3D)
{
    ...
    {
        double dx = 1.0 / n;
        using Layout = typename PHARE::core::PHARE_Types<PHARE::SimOpts{3, 2}>::MHD::GridLayout_t;
