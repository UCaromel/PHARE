...
inline constexpr PHARE::SimOpts mhdO4Opts{
    Dimension, 0, 0, PHARE::MHDOpts::MHDOrder::O4,
    PHARE::MHDOpts::TimeIntegratorType::SSPRK4_5,
    PHARE::MHDOpts::ReconstructionType::WENOZ, PHARE::MHDOpts::SlopeLimiterType::None,
    PHARE::MHDOpts::RiemannSolverType::Rusanov, true};
...
TEST(HallConvergence, WENOZReconstruct1D)
{
    ...
    {
        double dx = 1.0 / n;
        using Layout = typename PHARE::core::PHARE_Types<mhdO4Opts<1>>::MHD::GridLayout_t;
...
TEST(HallConvergence, EdgeToCellProjection3D)
{
    ...
    {
        double dx = 1.0 / n;
        using Layout = typename PHARE::core::PHARE_Types<mhdO4Opts<3>>::MHD::GridLayout_t;
        ...
        auto projection = Layout::implT::edgeXToCellCenter();
...
TEST(HallConvergence, DoubleReconstruction3D)
{
    ...
    for (auto n : nCells)
    {
        ...
        auto projection   = Layout::implT::edgeYToCellCenter();
