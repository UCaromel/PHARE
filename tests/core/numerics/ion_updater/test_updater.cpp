...
struct ElectromagBuffers
{
    ...
    using Grid             = typename PHARETypes::Hybrid::Grid_t;
    using GridLayout       = typename PHARETypes::Hybrid::GridLayout_t;
    using Electromag       = typename PHARETypes::Hybrid::Electromag_t;
...
struct IonsBuffers
{
    ...
    using Grid                       = typename PHARETypes::Hybrid::Grid_t;
    using GridLayout                 = typename PHARETypes::Hybrid::GridLayout_t;
    using Ions                       = typename PHARETypes::Hybrid::Ions_t;
    using ParticleArray              = typename PHARETypes::Hybrid::ParticleArray_t;
    using ParticleInitializerFactory = typename PHARETypes::Hybrid::ParticleInitializerFactory_t;
...
struct IonUpdaterTest : public ::testing::Test
{
    ...
    using Field            = typename PHARETypes::Hybrid::Grid_t;
    using VecField         = typename PHARETypes::Hybrid::VecField_t;
    using UsableVecFieldND = UsableVecField<dim>;
