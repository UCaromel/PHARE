...
class ACollectionOfParticles_1d : public ::testing::Test
{
    ...
    using PHARE_TYPES      = PHARE_Types<opts>;
    using ParticleArray_t  = typename PHARE_TYPES::Hybrid::ParticleArray_t;
    using GridLayout_t     = typename PHARE_TYPES::Hybrid::GridLayout_t;
    using Grid_t           = typename PHARE_TYPES::Hybrid::Grid_t;
