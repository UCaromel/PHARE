...
constexpr PHARE::SimOpts mhdOpts(PHARE::MHDOpts::ReconstructionType reconstruction)
{
    return PHARE::SimOpts{1,
                          0,
                          0,
...
static_assert(mhdOpts(PHARE::MHDOpts::ReconstructionType::Constant).mhd_axes_consistent());
static_assert(!mhdOpts(PHARE::MHDOpts::ReconstructionType::Constant).hybrid_enabled);

TEST(GridLayoutIntegration, MHDConstantReconstruction)
{
    static constexpr auto opts = mhdOpts(PHARE::MHDOpts::ReconstructionType::Constant);
...
{
    static constexpr auto opts = mhdOpts(PHARE::MHDOpts::ReconstructionType::Linear);
    using Layout               = PHARE_Types<opts>::MHD::GridLayout_t;
...
{
    static constexpr auto opts = mhdOpts(PHARE::MHDOpts::ReconstructionType::WENOZ);
    using Layout               = PHARE_Types<opts>::MHD::GridLayout_t;
...
TEST(GridLayoutIntegration, GhostAlwaysEven)
{
    ...
    static constexpr auto constOpts = mhdOpts(PHARE::MHDOpts::ReconstructionType::Constant);
    static constexpr auto linOpts   = mhdOpts(PHARE::MHDOpts::ReconstructionType::Linear);
    static constexpr auto wenoOpts  = mhdOpts(PHARE::MHDOpts::ReconstructionType::WENOZ);
