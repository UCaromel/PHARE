...
class UsableFieldMHD : public Field<dim, PhysicalQuantity::Scalar, double>
{
public:
    auto static constexpr dimension = dim;
    using Super                     = Field<dim, PhysicalQuantity::Scalar, double>;
    using Grid_t                    = Grid<NdArrayVector<dim>, PhysicalQuantity::Scalar>;
    using scalar_t                  = PhysicalQuantity::Scalar;
