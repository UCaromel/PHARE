...
PHAREDict getDict()
{
    ...
    dict["Etot"]["initializer"] = etotInit<1>(
        gamma, static_cast<initfunc>(density), static_cast<initfunc>(vx),
        static_cast<initfunc>(vy), static_cast<initfunc>(vz), static_cast<initfunc>(bx),
        static_cast<initfunc>(by), static_cast<initfunc>(bz), static_cast<initfunc>(pressure));
