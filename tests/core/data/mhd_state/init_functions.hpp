...
mulInit(PHARE::initializer::InitFunction<dim> a, PHARE::initializer::InitFunction<dim> b)
{
    return [a = std::move(a), b = std::move(b)](
               auto const&... coords) -> std::shared_ptr<PHARE::core::Span<double>> {
        auto sa = a(coords...);
        auto sb = b(coords...);
